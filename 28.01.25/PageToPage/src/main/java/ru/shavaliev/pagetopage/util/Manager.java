package ru.shavaliev.pagetopage.util;
...
import ru.shavaliev.pagetopage.HelloApplication;
...
public class Manager {
    ...
    public static void showSecondStage(String fxmleName, String title) {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource(fxmleName));
        try {
